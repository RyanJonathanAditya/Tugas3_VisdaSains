...
let zoom = 0.3 // Zoom scale
let warp = 10; // Time scale
let pause = false;
...
function setup() {
  ...
  Saturn = new Planet(["Saturn", 50724*2 , 1514.5*2, 1352.5*2, 10759*2, color('grey')]);
  Uranus = new Planet(["Uranus", 106724*2, 3008*2, 2742*2, 30689*2, color('cyan')]);
  Neptune = new Planet(["Neptune", 96464*2, 4540, 4460, 60182, color('yellow')]);
}
